...
const Home: NextPage = () => {
  ...
  return (
    <Layout>
      ...
      {/* Admin Entry - Only visible for admins, but we're adding it in the frontend for demo */}
      <div className="fixed bottom-6 right-6 z-20">
        <Link 
          href="/admin/dashboard" 
          className="bg-gray-800 hover:bg-gray-700 text-white p-3 rounded-full shadow-xl flex items-center justify-center transition-all hover:scale-110"
          aria-label="管理员入口"
        >
